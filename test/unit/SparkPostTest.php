...
class SparkPostTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->resource = new SparkPost($this->adapterMock, array('key' => 'a key'));
    ...
    {
        $sparky = new SparkPost(new CurlHttpAdapter(), array('key' => 'a key'));
    ...
    {
        $this->resource->setConfig(array('not' => 'a key'));
    }
